 ...
 */
public class CustomRequestConverters {
    ...
    static Request delete(DeleteRequest deleteRequest) {
        ...
        CustomRequestConverters.Params parameters = new CustomRequestConverters.Params(request);
    ...
    static Request search(SearchRequest searchRequest, String searchEndpoint) throws IOException {
        ...
        CustomRequestConverters.Params params = new CustomRequestConverters.Params(request);
        // 5.6ES 无法识别改参数
        params.putParam("track_total_hits", "true");
    ...
    private static void addSearchRequestParams(CustomRequestConverters.Params params, SearchRequest searchRequest) {
    ...
    private static Request prepareReindexRequest(ReindexRequest reindexRequest, boolean waitForCompletion) throws IOException {
        String endpoint = new CustomRequestConverters.EndpointBuilder().addPathPart("_reindex").build();
        Request request = new Request(HttpPost.METHOD_NAME, endpoint);
        CustomRequestConverters.Params params = new CustomRequestConverters.Params(request)
    ...
    private static Request rethrottle(RethrottleRequest rethrottleRequest, String firstPathPart) {
        String endpoint = new CustomRequestConverters.EndpointBuilder().addPathPart(firstPathPart).addPathPart(rethrottleRequest.getTaskId().toString())
    ...
    static Request putScript(PutStoredScriptRequest putStoredScriptRequest) throws IOException {
        String endpoint = new CustomRequestConverters.EndpointBuilder().addPathPartAsIs("_scripts").addPathPart(putStoredScriptRequest.id()).build();
        Request request = new Request(HttpPost.METHOD_NAME, endpoint);
        CustomRequestConverters.Params params = new CustomRequestConverters.Params(request);
    ...
    static Request analyze(AnalyzeRequest request) throws IOException {
        CustomRequestConverters.EndpointBuilder builder = new CustomRequestConverters.EndpointBuilder();
    ...
    static Request termVectors(TermVectorsRequest tvrequest) throws IOException {
        String endpoint = new CustomRequestConverters.EndpointBuilder().addPathPart(
    ...
    static Request getScript(GetStoredScriptRequest getStoredScriptRequest) {
        String endpoint = new CustomRequestConverters.EndpointBuilder().addPathPartAsIs("_scripts").addPathPart(getStoredScriptRequest.id()).build();
        Request request = new Request(HttpGet.METHOD_NAME, endpoint);
        CustomRequestConverters.Params params = new CustomRequestConverters.Params(request);
    ...
    static Request deleteScript(DeleteStoredScriptRequest deleteStoredScriptRequest) {
        String endpoint = new CustomRequestConverters.EndpointBuilder().addPathPartAsIs("_scripts").addPathPart(deleteStoredScriptRequest.id()).build();
        Request request = new Request(HttpDelete.METHOD_NAME, endpoint);
        CustomRequestConverters.Params params = new CustomRequestConverters.Params(request);
    ...
    static String endpoint(String index, String type, String id) {
        return new CustomRequestConverters.EndpointBuilder().addPathPart(index, type, id).build();
    }

    static String endpoint(String index, String type, String id, String endpoint) {
        return new CustomRequestConverters.EndpointBuilder().addPathPart(index, type, id).addPathPartAsIs(endpoint).build();
    }

    static String endpoint(String[] indices) {
        return new CustomRequestConverters.EndpointBuilder().addCommaSeparatedPathParts(indices).build();
    }

    static String endpoint(String[] indices, String endpoint) {
        return new CustomRequestConverters.EndpointBuilder().addCommaSeparatedPathParts(indices).addPathPartAsIs(endpoint).build();
    }

    static String endpoint(String[] indices, String[] types, String endpoint) {
        return new CustomRequestConverters.EndpointBuilder().addCommaSeparatedPathParts(indices).addCommaSeparatedPathParts(types)
                .addPathPartAsIs(endpoint).build();
    }

    static String endpoint(String[] indices, String endpoint, String[] suffixes) {
        return new CustomRequestConverters.EndpointBuilder().addCommaSeparatedPathParts(indices).addPathPartAsIs(endpoint)
                .addCommaSeparatedPathParts(suffixes).build();
    }

    static String endpoint(String[] indices, String endpoint, String type) {
        return new CustomRequestConverters.EndpointBuilder().addCommaSeparatedPathParts(indices).addPathPartAsIs(endpoint).addPathPart(type).build();
    }
    ...
    static class Params {
        ...
        CustomRequestConverters.Params putParam(String name, String value) {
        ...
        CustomRequestConverters.Params putParam(String key, TimeValue value) {
            if (value != null) {
        ...
        CustomRequestConverters.Params withDocAsUpsert(boolean docAsUpsert) {
            if (docAsUpsert) {
        ...
        CustomRequestConverters.Params withFetchSourceContext(FetchSourceContext fetchSourceContext) {
        ...
        CustomRequestConverters.Params withFields(String[] fields) {
        ...
        CustomRequestConverters.Params withMasterTimeout(TimeValue masterTimeout) {
            return putParam("master_timeout", masterTimeout);
        }

        CustomRequestConverters.Params withParent(String parent) {
            return putParam("parent", parent);
        }

        CustomRequestConverters.Params withPipeline(String pipeline) {
            return putParam("pipeline", pipeline);
        }

        CustomRequestConverters.Params withPreference(String preference) {
            return putParam("preference", preference);
        }

        CustomRequestConverters.Params withRealtime(boolean realtime) {
            if (realtime == false) {
        ...
        CustomRequestConverters.Params withRefresh(boolean refresh) {
            if (refresh) {
         ...
         */
        @Deprecated
        CustomRequestConverters.Params withRefreshPolicy(WriteRequest.RefreshPolicy refreshPolicy) {
        ...
        CustomRequestConverters.Params withRefreshPolicy(RefreshPolicy refreshPolicy) {
        ...
        CustomRequestConverters.Params withRequestsPerSecond(float requestsPerSecond) {
        ...
        CustomRequestConverters.Params withRetryOnConflict(int retryOnConflict) {
        ...
        CustomRequestConverters.Params withRouting(String routing) {
            return putParam("routing", routing);
        }

        CustomRequestConverters.Params withStoredFields(String[] storedFields) {
        ...
        CustomRequestConverters.Params withTimeout(TimeValue timeout) {
            return putParam("timeout", timeout);
        }

        CustomRequestConverters.Params withUpdateAllTypes(boolean updateAllTypes) {
            if (updateAllTypes) {
        ...
        CustomRequestConverters.Params withVersion(long version) {
        ...
        CustomRequestConverters.Params withVersionType(VersionType versionType) {
            if (versionType != VersionType.INTERNAL) {
        ...
        CustomRequestConverters.Params withWaitForActiveShards(ActiveShardCount currentActiveShardCount, ActiveShardCount defaultActiveShardCount) {
        ...
        CustomRequestConverters.Params withIfSeqNo(long ifSeqNo) {
        ...
        CustomRequestConverters.Params withIfPrimaryTerm(long ifPrimaryTerm) {
        ...
        CustomRequestConverters.Params withWaitForActiveShards(ActiveShardCount activeShardCount) {
         ...
         */
        @Deprecated
        CustomRequestConverters.Params withCopySettings(Boolean setCopySettings) {
        ...
        CustomRequestConverters.Params withIndicesOptions(IndicesOptions indicesOptions) {
        ...
        CustomRequestConverters.Params withIgnoreUnavailable(boolean ignoreUnavailable) {
            // Always explicitly place the ignore_unavailable value.
            putParam("ignore_unavailable", Boolean.toString(ignoreUnavailable));
            return this;
        }

        CustomRequestConverters.Params withHuman(boolean human) {
            if (human) {
        ...
        CustomRequestConverters.Params withLocal(boolean local) {
            if (local) {
        ...
        CustomRequestConverters.Params withIncludeDefaults(boolean includeDefaults) {
            if (includeDefaults) {
        ...
        CustomRequestConverters.Params withPreserveExisting(boolean preserveExisting) {
            if (preserveExisting) {
        ...
        CustomRequestConverters.Params withDetailed(boolean detailed) {
            if (detailed) {
        ...
        CustomRequestConverters.Params withWaitForCompletion(Boolean waitForCompletion) {
            return putParam("wait_for_completion", waitForCompletion.toString());
        }

        CustomRequestConverters.Params withNodes(String[] nodes) {
        ...
        CustomRequestConverters.Params withActions(String[] actions) {
        ...
        CustomRequestConverters.Params withTaskId(TaskId taskId) {
        ...
        CustomRequestConverters.Params withParentTaskId(TaskId parentTaskId) {
        ...
        CustomRequestConverters.Params withVerify(boolean verify) {
            if (verify) {
        ...
        CustomRequestConverters.Params withWaitForStatus(ClusterHealthStatus status) {
            if (status != null) {
        ...
        CustomRequestConverters.Params withWaitForNoRelocatingShards(boolean waitNoRelocatingShards) {
        ...
        CustomRequestConverters.Params withWaitForNoInitializingShards(boolean waitNoInitShards) {
            if (waitNoInitShards) {
        ...
        CustomRequestConverters.Params withWaitForNodes(String waitForNodes) {
            return putParam("wait_for_nodes", waitForNodes);
        }

        CustomRequestConverters.Params withLevel(ClusterHealthRequest.Level level) {
            return putParam("level", level.name().toLowerCase(Locale.ROOT));
        }

        CustomRequestConverters.Params withWaitForEvents(Priority waitForEvents) {
    ...
    static class EndpointBuilder {
        ...
        CustomRequestConverters.EndpointBuilder addPathPart(String... parts) {
        ...
        CustomRequestConverters.EndpointBuilder addCommaSeparatedPathParts(String[] parts) {
            addPathPart(String.join(",", parts));
            return this;
        }

        CustomRequestConverters.EndpointBuilder addCommaSeparatedPathParts(List<String> parts) {
            addPathPart(String.join(",", parts));
            return this;
        }

        CustomRequestConverters.EndpointBuilder addPathPartAsIs(String ... parts) {
            for (String part : parts) {
                if (Strings.hasLength(part)) {
                    joiner.add(part);
                }
